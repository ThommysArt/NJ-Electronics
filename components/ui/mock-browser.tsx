...
export const BrowserComponent: React.FC<{ children?: React.ReactNode; className?: string }> = ({
  ...
  <div
    className={cn(
      'relative text-sm text-muted-foreground rounded-lg w-full h-[400px] dark:shadow-none shadow-lg shadow-gray-200 dark:dots-neutral-800 dots-background-muted border',
      className
    )}
  >
    <div
    ...
    >
      ...
      >
        ...
        <span className={'text-sm flex items-center justify-center'}>
          nj-electronics.vercel.app/store
        </span>
      </div>
      <div />
    </div>
